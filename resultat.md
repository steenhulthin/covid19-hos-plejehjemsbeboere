...
- Brug farver som er synlige i både light og dark mode setting i streamlit. Følg guidelines fra <https://docs.streamlit.io/develop/concepts/configuration/theming>
